...
export default {
  ...
  async created() {
    ...
    for (var i = 0; i < self.elements.length; i++) {
      ...
      if (elmt.id == self.$parent._data.instance) {
        fElment = elmt;
      }
    }
    self.found = fElment;
...
.b-skeleton-animate-fade {
  -webkit-animation: b-skeleton-animate-fade 875ms ease-in-out alternate
    infinite;
...
.b-icon.b-iconstack .b-icon-animation-cylon-vertical > g {
  -webkit-transform-origin: center;
  transform-origin: center;
  -webkit-animation: 0.75s infinite ease-in-out alternate
    b-icon-animation-cylon-vertical;
  animation: 0.75s infinite ease-in-out alternate
    b-icon-animation-cylon-vertical;
}
@media (prefers-reduced-motion: reduce) {
  .b-icon.b-icon-animation-cylon-vertical,
...
@import url("https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700&family=Outfit:wght@100;200;300;400;500;600&family=Rubik:wght@500&display=swap");
#app {
